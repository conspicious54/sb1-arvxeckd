      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-green-50 dark:border-gray-700">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900 dark:text-white">
              {stats.totalEarned.toLocaleString()} <span className="text-sm font-normal">pts</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-green-50 dark:border-gray-700">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900 dark:text-white">
              {stats.potentialEarnings.toLocaleString()} <span className="text-sm font-normal">pts</span>
            </p>
          </div>
        </div>
      </div>
